...
import { Layers, Calendar as CalendarIcon, Building2 } from 'lucide-react';

export const OrganizerBottomNav: React.FC = () => {
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              key={item.name}
              href={item.href}
              className={`flex flex-col items-center justify-center w-24 py-1 transition-colors duration-200 ${
